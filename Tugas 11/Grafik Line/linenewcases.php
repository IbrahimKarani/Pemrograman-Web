...
$nama_negara[] = $row['nama_negara'];
	...
	$query = mysqli_query($koneksi,"SELECT new_cases AS New_Cases FROM tb_case WHERE id_negara='".$row['id_negara']."'");
...
<body id="body"><center>
	<header><center><h1 id="title">COVID-19 New Cases in Top 10 Country</h1></center></header>
